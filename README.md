...
http://wiki.sunfounder.cc/index.php?title=To_use_USB_mini_microphone_on_Raspbian go through the following instructions to record your voice and purchase the microphone.Then use the program to control the GPIO pins.
